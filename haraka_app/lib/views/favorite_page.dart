...
import '../components/haraka_appbar.dart';
...
class _FavoritePageState extends State<FavoritePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: harakaAppBar(context, title: 'Favorite', leading: true),
        body: Container(
                        ...
                        Row(
                          ...
                          children: [
                            Text(data[index]['name'],
                                style:
                                    HarakaFonts(context).boldInter(size: 16)),
                            IconButton(
                              onPressed: () {
                                data.remove(data[index]);

                                SaveToLocalDb.setString(
                                    'favorite', jsonEncode(data));
                                ...
                                alert(context,
                                    ...
                                    color: Colors.red,
                                    text:
                                        'Data ${data[index]['name']} berhasil di hapus');
                              },
